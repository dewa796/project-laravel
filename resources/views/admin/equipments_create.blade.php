...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="/inventory/equipments/insert" method="POST" enctype="multipart/form-data">
            @csrf

          <div class="form-group">
            <label for="exampleInputName1">Item Name</label>
            <input type="text" class="form-control @error('equipments_name') is-invalid @enderror" placeholder="Item Name" name="equipments_name" value="{{ old('equipments_name') }}">
