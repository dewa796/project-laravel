          ...
          <div class="card-body">
            ...
            <div class="d-sm-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <p class="card-subtitle card-subtitle-dash">You have {{ $kits->count(); }} data Kits</p>
                </div>
                <div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                        <a href="/inventory/kits/detail/{{ $item->id }}" class=""><i class="icon-sm mdi mdi-eye text-success"></i></a>
                        <a href="/inventory/kits/edit/{{ $item->id }}" class="px-2"><i class="icon-sm mdi mdi-table-edit text-primary"></i></a>
